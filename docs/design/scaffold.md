...
## Overview
The Scaffold tool is a project generator script (`sagittarius_engine/tools/scaffold.py`) that quickly bootstraps a new Sagittarius application following Clean Architecture folder structures.
...
### `def create_project(project_name: str, base_path: str = ".") -> None` (in `sagittarius_engine/tools/scaffold.py`)
...
```bash
python sagittarius_engine/tools/scaffold.py my_awesome_app
cd my_awesome_app
python main.py
```
