...
def test_context_class_initialization():
    ...
    original_abstract_methods = EngineContext.__abstractmethods__
    try:
        # Disable abstract methods check to allow instantiation of the snippet class
        EngineContext.__abstractmethods__ = frozenset()
        ...
        # Act
        context = EngineContext(app=app_mock, container=container_mock, event_bus=event_bus_mock)
        ...
        EngineContext.__abstractmethods__ = original_abstract_methods
